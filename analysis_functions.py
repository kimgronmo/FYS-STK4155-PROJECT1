...
def biasVariance(regression,maxPolyDegree,polynomial,x,y,z,n_bootstraps,error, \
    ...
    # Plotting data for exercise2)
        ...
        plt.savefig(os.path.join(os.path.dirname(__file__), 'Results/FigureFiles', 'Exercise2 MSE vs poly sample 1000.png'), transparent=True, bbox_inches='tight')
        ...
        plt.legend([r"mse from training data"], fontsize=10)
        plt.savefig(os.path.join(os.path.dirname(__file__), 'Results/FigureFiles', 'Exercise2 Bias vs poly sample 1000.png'), transparent=True, bbox_inches='tight')
        ...
        plt.legend([r"mse from training data"], fontsize=10)
        plt.savefig(os.path.join(os.path.dirname(__file__), 'Results/FigureFiles', 'Exercise2 Variance vs poly sample 1000.png'), transparent=True, bbox_inches='tight')
